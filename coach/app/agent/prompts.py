...
SYSTEM_PROMPT = (
    ...
    "\n"
    "Durable profile:\n"
    "- If a Durable profile block is present in this system prompt, use those goals and facts "
    "to personalize the closing suggestion for today.\n"
    "- Never invent goals or facts that are not listed there.\n"
    "\n"
...
CHAT_SYSTEM_PROMPT = (
    ...
    "- Never invent goals or facts that are not listed there.\n"
    "- You cannot save memory yourself. If they ask you to remember something, tell them to "
    "use /goal or /fact.\n"
    "\n"
    "Timezones:\n"
    "- Tool results include start_local, end_local, local_start_time, and local_end_time. "
