...
<CardGroup cols={2}>
  <Card title="Claude Custom Connector" icon="mobile" href="/mcp-server/claude-custom-connector">
    Remote MCP with OAuth for Claude mobile and claude.ai.
  </Card>
  <Card title="Managed Agents (HTTPS)" icon="cloud" href="/mcp-server/managed-agents-remote">
    Remote MCP with Bearer vault auth for the Claude Managed Agents API.
  </Card>
  ...
  <Card title="Telegram health coach" icon="paper-plane" href="/coach">
    Two-way Telegram bot: daily briefing plus chat over sleep, workouts, and activity.
  </Card>
</CardGroup>
